        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="../vistas/layout.php" class="site_title"><i class="fa fa-paw"></i> <span>Colegio Huellas</span></a>
            </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Salir" href="../controladores/usuarioSalirControlador.php">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <a class="dropdown-item"  href="javascript:;">Ayuda</a>
                    <a class="dropdown-item"  href="../controladores/usuarioSalirControlador.php"><i class="fa fa-sign-out pull-right"></i> Salir</a>
                  </div>
                </li>
              </ul>
            </nav>
   ...
   ?>
        ...
        <!-- <footer>
          <div class="pull-right">
            CRUD - CRISTIAN FELIPE LAITON VARGAS</a>
          </div>
          <div class="clearfix"></div>
        </footer> -->
        <!-- /footer content -->
